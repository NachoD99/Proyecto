...
namespace TP_3
{
    ...
    class Curso
    {
        ...
        private DateTime fechaFinalizacion { get; set; }
   ...
   public Curso(string nombreCurso, string dias, string horarios, int cupoDisponible, int cupoMinimo, bool estadoCurso, 
    ...
    class Alumno
    {
        ...
        private bool pagoMatricula { get; set; }
        public string nombreCursoInscripto { get; set; }
        public DateTime fechaInscripcion { get; set; }
    ...
    class Inscripcion
    {
        ...
        private static List<Alumno> alumnosEnCurso = new List<Alumno>();
        private static List<Docente> docentesEnCurso = new List<Docente>();
        private static List<PublicoGeneral> publicoEnCurso = new List<PublicoGeneral>();
